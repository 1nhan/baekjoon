...
void print_answer()
{
	...
	if (string_a.size() > 3) return;
	if (string_b.size() != string_a.size()) return;
	...
	temp_a = string_a[0];
	string_a[0] = string_a[string_a.size()-1];
	string_a[string_a.size()-1] = temp_a;

	temp_b = string_b[0];
	string_b[0] = string_b[string_b.size()-1];
	string_b[string_b.size()-1] = temp_b;
	

	if (string_a < string_b)cout << string_b;
	else cout << string_a;
	/*
	*/
}
